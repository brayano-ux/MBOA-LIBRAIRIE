...
<body id="bod" data-aos="fade-down-right">
        ...
        <div class="container">
            <div class="entete-content">
                ...
                <div class="entete-actions">
                    ...
                    <button class="btn btn-secondary" id="temps">☀️ Jour</button>
    ...
    <footer>
        <p>© 2025 MBOA Librairie - Tous droits réservés</p>
        <div class="lien">
            <a href="#" title="Facebook"><i class="fab fa-facebook"></i> Facebook</a>
            <a href="https://wa.me/237657300644" title="WhatsApp"><i class="fab fa-whatsapp"></i> WhatsApp</a>
        </div>
    </footer>
    ...
    <script type="module">
        ...
        searchBar.addEventListener("input", function () {
            ...
            const filtered = allAnnonces.filter((annonce) =>
                ...
                (annonce.classe && annonce.description.toLowerCase().includes(searchTerm)) ||
                (annonce.lieu && annonce.description.toLowerCase().includes(searchTerm))
            );
            filtered.forEach((annonce) => {
                const li = document.createElement("li");
                li.textContent = annonce.nomProduit + " - " + annonce.description
                annonce.classe + " - " + annonce.lieu;
                li.onclick = () => {
        ...
        async function afficheravis(avisList) {
            ...
            avisList.forEach(async (avis) => {
                ...
                bloc.innerHTML = `<p><strong>Note: ${avis.rating}<br>
